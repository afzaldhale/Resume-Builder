...
export const PDF_CONFIG = {
  ...
  TEMPLATES: {
    1: { name: "Clean Single Column", safeZone: { top: 36, bottom: 36, left: 36, right: 36 } },
    2: { name: "Corporate Sidebar Blue", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    3: { name: "Colored Heading Corporate", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    4: { name: "Left Accent Teal", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    5: { name: "Premium Gray Sidebar", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    6: { name: "Professional Sidebar Teal", safeZone: { top: 24, bottom: 24, left: 24, right: 24 } },
    7: { name: "Muted Coral Corporate", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    8: { name: "Compact ATS Single", safeZone: { top: 36, bottom: 36, left: 36, right: 36 } },
    9: { name: "Premium Charcoal Sidebar", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    10: { name: "Blue Heading Corporate", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    11: { name: "Classic Two Column", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    12: { name: "Soft Green Corporate", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    13: { name: "Rose Sidebar Corporate", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    14: { name: "Minimal Left Accent", safeZone: { top: 36, bottom: 36, left: 36, right: 36 } },
    15: { name: "Corporate Clean", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
  },
};
