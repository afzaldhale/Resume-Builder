...
export const PDF_CONFIG = {
  ...
  TEMPLATES: {
    1: { name: "Recruiter Choice", safeZone: { top: 36, bottom: 36, left: 36, right: 36 } },
    2: { name: "Premium Executive", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    3: { name: "Prime Executive", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    4: { name: "Elite Executive", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    5: { name: "Executive Signature", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    6: { name: "Executive Edge", safeZone: { top: 24, bottom: 24, left: 24, right: 24 } },
    7: { name: "Classic Executive", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    8: { name: "Corporate Standard", safeZone: { top: 36, bottom: 36, left: 36, right: 36 } },
    9: { name: "Career Pro", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    10: { name: "Classic Professional", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    11: { name: "Corporate Professional", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    12: { name: "Modern Professional", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    13: { name: "Career Essential", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
    14: { name: "Career Prime", safeZone: { top: 36, bottom: 36, left: 36, right: 36 } },
    15: { name: "Executive Prestige", safeZone: { top: 32, bottom: 32, left: 32, right: 32 } },
  },
};
